        ...
        <div id="navbar">
            <span class="inbar">
                <ul>
                    ...
                    <li class="navhome"><a href="AdministracionUsuarios.jsp"><span>Gestion de Usuario</span></a></li>
                    ...
                    <li><a href="../Pagina_Ventas/Ingreso_Productos.jsp"><span>Agregar Productos</span></a></li>
                    <li><a href="../Pagina_Ventas/Administracion_De_Productos.jsp"><span>Gestion de Productos</span></a></li><%}%>
                    <%if(s.getAttribute("rol").equals("Administrador")|| s.getAttribute("rol").equals("Vendedor")){%>
                    <li><a href="../Pagina_Ventas/Despacho.jsp"><span>Ventas</span></a></li><%}%>
                    <li><a href="../Pagina_Ventas/Historial.jsp"><span>Sus Pedidos</span></a></li>
                    ...
                    <li><a href="TerminoCondiciones.jsp"><span><img src="../img/iconLogin.png"/> &nbsp;Registrarse</span></a></li>
                    <li><a href="../Mensajeria/NuevoMensaje.jsp"><span>Mensajes al Administrador</span></a></li>
                    <%}%>
