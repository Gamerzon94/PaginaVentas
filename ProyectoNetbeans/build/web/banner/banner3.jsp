        ...
        <div id="navbar">
            <span class="inbar">
                <ul>
                    ...
                    <li><a href="Ingreso_Productos.jsp"><span>Agregar Productos</span></a></li>
                    <li class="navhome"><a href="Administracion_De_Productos.jsp"><span>Gestion de Productos</span></a></li><%}%>
